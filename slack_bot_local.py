...
def process_with_claude(user_message: str, user_email: str, mentioned_users: Optional[Dict[str, Dict]] = None,
    ...
    try:
        ...
        _STATIC_SYSTEM = (
            ...
            "  For each active system, describe 3-4 specific tasks: access requests, violation queries, role analysis, compliance reporting.'\n"
            ...
            "If you add new integrations later, they will automatically appear.\n\n"
