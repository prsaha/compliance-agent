...
def process_with_claude(user_message: str, user_email: str, mentioned_users: Optional[Dict[str, Dict]] = None,
    ...
    try:
        ...
        _STATIC_SYSTEM = (
            ...
            "If asked about violations in a department or by severity, call list_violations(department=..., severity=...) — it returns user names, emails, and conflicting role pairs directly without needing individual emails first. "
